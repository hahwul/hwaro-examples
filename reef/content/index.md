...
<section class="hero">
  <div class="hero-content">
    <p class="hero-subtitle">Diving &amp; underwater log &mdash; a personal record of ocean explorations.</p>
  </div>
  <div class="hero-wave" aria-hidden="true">
    <svg viewBox="0 0 1200 60" preserveAspectRatio="none">
      <path d="M0,30 C100,50 300,10 450,30 C600,50 750,10 900,30 C1050,50 1150,20 1200,30" fill="none" stroke="#2ec4b6" stroke-width="1.5" opacity="0.4"/>
      <path d="M0,40 C200,15 350,50 550,35 C750,20 950,50 1200,35" fill="none" stroke="#e07a5f" stroke-width="1" opacity="0.3"/>
      <path d="M0,20 C250,40 500,5 700,25 C900,45 1100,10 1200,25" fill="none" stroke="#5fb4c9" stroke-width="1" opacity="0.25"/>
    </svg>
  </div>
</section>
