...
date = "2026-03-20"
description = "A system for building a personal knowledge base through atomic, interconnected notes"
tags = ["evergreen", "productivity", "note-taking", "knowledge-management"]
categories = ["methods"]
+++

The Zettelkasten (German for "slip box") is a knowledge management method developed by sociologist Niklas Luhmann. He used this system to produce over 70 books and nearly 400 scholarly articles during his career.
...
1. **Capture** fleeting thoughts and highlights from reading
2. **Process** captures into permanent, atomic notes
3. **Connect** each note to relevant existing notes
4. **Develop** clusters of notes into outlines and arguments
...
- Luhmann's original paper on communicating with slip boxes
