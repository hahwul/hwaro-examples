/* Salon — overlay search. The header button or the "/" key opens a modal
   dialog; typing searches the criticism archive via Fuse.js. Arrow keys
   move the selection, Enter opens it, Esc closes and returns focus to
...
(function () {
  ...
  function render(query) {
    ...
    if (!q) {
      list.innerHTML = '';
      status.textContent = 'Type to search the criticism archive.';
      return;
    }
