/* Magnetite — command-palette search.
   ...
   — never innerHTML — so indexed content can never inject markup. Fuse's own
   fuzziness gives the palette the same typo tolerance the server ships. */
(function () {
  'use strict';
