/* Inline guide search for Hawthorn.
   Typing in the search field swaps the species grid for a results list in
...
(function () {
  ...
  var input = document.getElementById('hawthorn-search');
  ...
  function run() {
    ...
    status.textContent = hits.length + (hits.length === 1 ? ' species found.' : ' species found.');
  }
