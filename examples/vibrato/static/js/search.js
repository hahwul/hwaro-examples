/* Vibrato — overlay search. The header button or the "/" key opens a modal
   dialog; typing searches session titles, artists, and notes via Fuse.js.
   Arrow keys move the selection, Enter opens it, Esc closes and returns
...
(function () {
  ...
  function render(query) {
    ...
    if (!q) {
      list.innerHTML = '';
      status.textContent = 'Type to search every session Vibrato has pressed.';
      return;
    }
