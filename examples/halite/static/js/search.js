/* Halite — inline sidebar search.
   A persistent input in the sidebar. Typing swaps the formula/guide nav
   tree for a live results list in place; clearing the field restores it.
   Fuse.js loads from the CDN in footer.html. Every result string is
   written with textContent — never innerHTML — so indexed content can
   never inject markup. */
(function () {
  'use strict';
