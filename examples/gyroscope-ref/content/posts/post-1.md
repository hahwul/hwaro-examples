...
date = "2025-02-14"
+++
Proper calibration is essential for accurate readings. The reference gyroscope must be allowed to spin up to its operational speed in a completely isolated environment to establish a baseline axis.

This document details the step-by-step procedure for zeroing the sensors and accounting for environmental drift. Failure to strictly follow these calibration steps will result in compounding errors over long-duration measurements.
