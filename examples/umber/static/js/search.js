/* Umber — overlay search. The header button or the "/" key opens a modal
   dialog; typing searches installations and mix notes via Fuse.js. Arrow
   keys move the selection, Enter opens it, Esc closes and returns focus
   to the trigger. */
(function () {
  'use strict';
  ...
  function render(query) {
    ...
    if (!q) {
      list.innerHTML = '';
      status.textContent = 'Type to search every room and its mix notes.';
      return;
    }
