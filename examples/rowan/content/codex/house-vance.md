...
title = "House Vance"
date = "2025-09-25"
description = "The ledger house whose underwriters price nearly every hull that sails the archipelago, and whose insurance rates function as unofficial law."
tags = ["houses", "finance", "founding-eleven"]
toc = true
[extra]
kind = "house"
ruler = "First Ledger Miriam Vance"
banner = "A balanced scale in gold thread, on cream"
founding_year = "Founded 41 YS"
seat = "The Vaultworks, Thornreach"
+++

House Vance owns no fleet worth the name and has never needed one. It was founded in 41 YS by a consortium of Sundering-era clerks and accountants who had kept the old imperial ledgers intact through the collapse and realized, correctly, that a stable archipelago would need someone to insure its cargo long before it needed anyone to carry it. Every major house now carries Vance paper, and the house's greatest asset is not gold but information: it knows, more precisely than any Assembly census, exactly what moves through the archipelago and what it is worth.
