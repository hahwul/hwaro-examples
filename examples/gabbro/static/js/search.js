/* gabbro — overlay search. The header button or the "/" key opens a modal
   dialog; typing greps the manual via Fuse.js. Arrow keys move the selection,
   Enter opens it, Esc closes and returns focus to the trigger. */
(function () {
  'use strict';
  ...
  function render(query) {
    ...
    if (!q) {
      results = [];
      list.innerHTML = '';
      status.textContent = 'Type to grep the manual and benchmarks.';
      return;
    }
