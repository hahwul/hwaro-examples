/* Loki — command palette search. Cmd+K / Ctrl+K opens a centered modal;
...
(function () {
  ...
  var IDLE = "grep -rnI \"query\" ./dispatches/ — arrow keys to move, Enter to open.";
  var fuse = null;
  var loading = false;
  var active = -1;
  var lastFocus = null;
  ...
  function load() {
    ...
    fetch(base + "/search.json")
      ...
      .catch(function () {
        if (status) status.textContent = "The search index would not load. Navigation still works.";
      });
  }
