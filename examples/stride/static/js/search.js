/* Stride — overlay search. The header button or the "/" key opens a modal
   dialog; typing searches the engagement record via Fuse.js. Arrow keys
   move the selection, Enter opens it, Esc closes and returns focus to the
   trigger. */
(function () {
  'use strict';
  ...
  function render(query) {
    ...
    if (!q) {
      list.innerHTML = '';
      status.textContent = 'Type to search the engagement record.';
      return;
    }
